          ...
          {PROGRAMMES.map((programme, i) => (
            <Reveal key={programme.title} delay={i * 0.07}>
              <motion.article
                ...
                initial="rest"
                animate="rest"
                className="group relative h-full overflow-hidden rounded-[1.6rem] border border-white/10 bg-navy-950/40"
              >
                ...
                <div className="relative p-7 sm:p-8">
                  ...
                  <motion.span
                    variants={{ rest: { width: '2.5rem' }, hover: { width: '5rem' } }}
                    transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1] }}
                    className="mt-7 block h-px bg-leaf-500"
                  />
                </div>
              </motion.article>
            </Reveal>
